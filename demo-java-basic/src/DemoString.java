public class DemoString {
    public static void main(String[] args) {
        ...
        if (s4.contains("lll")) {
            ...
            System.out.println("Does not contains Lll");
        }
        ...
        System.out.println(s14.indexOf("java")); // -1 (Can not find)
        System.out.println(s14.indexOf("CAMP")); // -1
        System.out.println(s14.indexOf(97)); // 5 (97 refer to A)
        ...
        String s18 = "abc";
        String s19 = "def";
        System.out.println(s18.compareTo(s19)); // -3 'a'-'d' ASCII
